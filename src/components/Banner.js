...
export const Banner = () => {
  ...
  const toRotate = [ "Business Analyst", "Full-Stack Developer", "System Analyst", "Quality Assurance" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`I'm Hiza Aliza`} 
                <br></br>
                <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Business Analyst", "Full-Stack Developer", "System Analyst", "Quality Assurance ]'><span className="wrap">{text}</span></span></h1>
                <br></br>
                <p>
